...
target_source = 'lsunb_train'  # mnist_train / mnist_test / cifar_train / cifar_test
...
generator_training_param = {'input_noise_dim': feature_dim, 'input_noise_batchsize': target_batch_size,
                            'input_noise_var': 0.3, 'net_type': 'resnet', 'lr': 2e-4, 'inner_ite_per_batch': 1,
...
adversarial_training_param = {'input_t_dim': feature_dim, 'input_t_batchsize': target_batch_size,
                              'input_t_var': 1, 'net_type': 'resnet', 'lr': 2e-4, 'inner_ite_per_batch': 1,
